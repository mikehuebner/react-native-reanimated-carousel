...
const config: DocsThemeConfig = {
  ...
  head: (
    <>
      ...
      <meta property="og:title" content="@mikehuebner/react-native-reanimated-carousel" />
      ...
      <meta name="twitter:title" content="@mikehuebner/react-native-reanimated-carousel" />
