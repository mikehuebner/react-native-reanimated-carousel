...
<div style={{ borderRadius: '8px', overflow: 'hidden' }}>![Cover Image](../../../assets/home-banner.png)</div>
<Badges />
...
**React Native Reanimated v2** needs extra steps to finalize its installation, please follow their
[installation instructions](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/getting-started).
...
<div className="flex flex-row items-center justify-center p-4 rounded-lg mb-4 mt-4 ss-content ">
  ...
  <div>
    ...
    <p className="text-sm">
      Thanks to{' '}
      <a className="font-bold underline text-[#792fdc]" href="https://www.screen.studio/@nGeEY">
        Screen Studio
      </a>{' '}
      for sponsoring this library. You can use Screen Studio to record your screen and edit videos and get beautiful
      screen recordings in minutes.
    </p>
  </div>
</div>
